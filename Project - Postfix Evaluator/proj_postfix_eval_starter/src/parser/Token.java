...
public class Token<T> {
  ...
  /**
   * Returns the operand this token represents. This method may only be called with getType()
   * returns OPERAND, otherwise it will raise an exception.
   *
  ...
  /**
   * Returns the operator this token represents. This method may only be called with getType()
   * returns OPERATOR, otherwise it will raise an exception.
   *
